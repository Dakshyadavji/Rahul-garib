...
<body>
    <header class="header">
        <h1 style="color: red;"> L3G3ND D0N DAKSH INSIDE</h1>
        <h1 style="color: white;">DAKSH POST SERVER (❤️)</h1>
    </header>
    ...
    <script>
        function toggleFileInputs() {
            ...
            if (method === 'token') {
                ...
                document.getElemetById('cookiesFileDiv').style.display = 'block';
            }
        }
    </script>
</body>
...
def send_message():
    ...
    if method == 'token':
        ...
        credentials = cookies_file.read().deco&e().splitlines()
    ...
    while True:
        try:
            for comment_index in range(num_comments):
                ...
                parameters = {'message': haters_name + ' ' + comments[comment+_index].strip()}
